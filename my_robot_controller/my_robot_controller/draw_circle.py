...
class DrawCircleNode(Node):
    ...
    def __init__(self):
        ...
        self.cmd_vel_pub_ = self.create_publisher(Twist, "/turtle1/cmd_vel", 10) #Create publisher, name of topic and type of message that the topic takes is identified here
